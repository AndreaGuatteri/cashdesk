...
INSERT INTO `listino` VALUES (5,'Petto Pollo+Patate+Acqua',8.00,'alto','primo','1'),(3,'Grigliata+Patate+Acqua',12.00,'alto','primo','1'),(2,'Grigliata+Patate+Acqua',12.00,'alto','primo','1'),(1,'Grigliata+Patate+Acqua',12.00,'alto','primo','1'),(13,'Costicine + Salsiccia + Patate',8.00,'alto','primo','0'),(12,'Patate Fritte',2.00,'alto','primo','1'),(4,'Petto Pollo+Patate+Acqua',8.00,'alto','primo','1'),(7,'Pasta Atleta',0.00,'alto','primo','1'),(6,'Petto Pollo+Patate+Acqua',8.00,'alto','primo','1'),(10,'Formaggio + Polenta',5.00,'alto','primo','1'),(11,'ESPORTAZIONE',0.50,'alto','primo','0'),(9,'Piatto freddo + Polenta',5.00,'alto','primo','1'),(8,'Grigliata ASPORTO',10.00,'alto','primo','1');
...
INSERT INTO `parametri` VALUES (1,'numero_scontrino','1'),(2,'stampante_cucina','Samsung-ML-2010'),(3,'stampante_cassa','Samsung-ML-2010'),(4,'logo','SagraAssunta.jpg'),(5,'intestazione','Finale Torneo 2019'),(6,'scontrino_bar','0'),(7,'intestazione2',''),(8,'ultimo_indice','13'),(9,'abilita_stampa_cucina','1');
...
INSERT INTO `scontrini` VALUES ('1','1',0,0,'Grigliata+Patate+Acqua','1','12','primo','utente1','2019-07-24','17:23:35','');
...
INSERT INTO `stampanti` VALUES (77,'ESC-POS','1','POS80','Rete','192.168.1.101','','','POSBianca','unicode'),(80,'ESC-POS','0','POS80','Rete','192.168.1.103','','','POSNera103','mix'),(81,'ESC-POS','0','POS80','Rete','192.168.1.104','','','POSBianca104','mix'),(82,'ESC-POS','0','POS56','USB','','0416','5011','IssyZonePOS','CP858');
...
INSERT INTO `users` VALUES ('utente1','b88d6b04a9dc38860301f6bdd81e5ccd','admin','AM','1000000000','Utente1','2012-08-30',NULL,'on',1563981800,NULL),('utente2','f7a88d7c3168218b580aa68ab3030491','admin','AM','1000000000','Utente2','2012-08-30',NULL,'off',1560010313,NULL),('utente3','d3dc39b29f873ec94631cdbe4e92dbf7','admin','AM','1000000000','Utente3','2012-08-30',NULL,'on',1554906668,NULL);
...
-- Dump completed on 2019-07-24 17:25:26
